...
Row 1 of the run's example figure (deleted 2026-09-19 — it visualised the LEAKED input and the description below is the surviving record): on `260622_316_H_b4_CBS_02__t0` the human labelled
...
(example figure deleted; it rendered the contaminated input)
