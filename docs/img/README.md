...
`260622_316_H_b2_front_CBS_01`, Pass 1 + Pass 2 + SAM. **No human labels from this
...
an image the classifier never saw.
    ...
    python3 build_figures.py 260622_316_H_b2_front_CBS_01 \
        --out docs/img/detection.png --frac 0.30 \
        --note "Pass 1 + Pass 2 + SAM; no human labels from this image were used"
